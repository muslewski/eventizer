  ...
  return (
    <div className="flex flex-row 2xl:flex-col gap-4 sm:gap-6 md:gap-8 2xl:gap-12 text-white pt-8 sm:pt-16 h-full">
      <div className="flex flex-col gap-0 2xl:gap-2">
        <h2 className="xl:text-8xl md:text-6xl text-5xl font-bebas max-w-7xl text-white dark:mix-blend-difference transform-gpu overflow-hidden pb-1 leading-none">
          {/* {infoTitle1} */}
          <BlurText
            text={infoTitle1 ?? ''}
            animateBy="letters"
