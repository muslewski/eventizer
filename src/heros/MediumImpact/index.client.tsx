...
export const MediumImpactHeroClient: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="xl:h-screen pt-4 sm:pt-8 xl:pt-0 w-full flex justify-center items-center">
      <div
        className="xl:h-[calc(100vh-64px)]  transition-[margin-top] rounded-2xl  py-0 px-0 sm:px-0 relative flex flex-col xl:flex-row gap-4 xl:gap-16 items-center w-full bg-white dark:bg-background"
        data-theme="dark"
      >
        {children}
      </div>
