...
export const HighImpactHeroClient: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    ...
    <div className="h-screen">
      <div className="h-dvh py-4 w-full flex justify-center items-center">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="absolute bottom-0 inset-0 opacity-5 bg-radial from-foreground via-transparent to-transparent" />
        </div>

        {/* -mt-12 sm:-mt-8 */}
        <div
          className="h-[calc(100dvh-32px)] sm:h-[calc(100dvh-64px)] w-full  high-impact-hero rounded-2xl overflow-hidden pb-8 sm:pb-16 pt-8 sm:pt-16  px-8 sm:px-16 relative"
          data-theme="dark"
        >
          {children}
        </div>
