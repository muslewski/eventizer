...
export function SingleImageUpload({ value, onChange, label, required }: SingleImageUploadProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      {value?.url ? (
        <div className="group relative aspect-video w-full max-w-sm overflow-hidden rounded-lg border border-border/20">
        ...
        <div
          ...
          className={cn(
            'flex aspect-video w-full max-w-sm cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed transition-colors',
...
export function VideoUpload({ value, onChange }: VideoUploadProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      {value?.url ? (
        <div className="flex flex-col gap-2">
          <div className="relative w-full max-w-sm overflow-hidden rounded-lg border border-border/20">
            <video
              src={value.url}
              controls
              className="w-full"
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          className={cn(
            'flex h-32 w-full max-w-sm cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed transition-colors',
            isUploading ? 'border-accent/40 bg-accent/5' : 'border-border/30 hover:border-accent/30 hover:bg-accent/5',
          )}
        >
          {isUploading ? (
