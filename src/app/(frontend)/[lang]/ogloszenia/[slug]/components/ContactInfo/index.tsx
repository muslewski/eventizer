...
const socialMediaConfig = [
  ...
  },
  {
    ...
    icon: Instagram,
    color:
      'hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F77737] hover:text-white hover:border-transparent',
  },
  {
    key: 'tiktok' as const,
    label: 'TikTok',
          ...
          <Card className="bg-transparent border-border/50">
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-2 gap-4">
                {socialMediaConfig.map(({ key, label, icon: Icon, color }) => {
                  ...
                  return (
                    <Button
                      key={key}
                      variant="outline"
                      className={`h-auto py-4 flex flex-col items-center gap-2 transition-all duration-300 ${color}`}
                      asChild
                    >
